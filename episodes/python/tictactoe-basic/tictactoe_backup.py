...
def setup():
    ...
    global ai_players
    placeholder = all_players
    ai_players = [list(all_players_dict.keys()).pop(0)]
    ...
    possible_wins = {1: [1, 2, 3], 4: [4, 5, 6], 7: [7, 8, 9], 11: [1, 4, 7], 12: [2, 5, 8], 13: [3, 6, 9], 21: [1, 5, 6], 23: [3, 5, 7]}
    # print(f' all_players_dict: {all_players_dict} \n all_players: {all_players} \n ai_players: {ai_players} \n playspace: {playspace} \n available_places: {available_places}')
    return
    
def blank_board_state(grid_size_square_root = 3):
...
def check_for_win(playspace):
    ...
    #rows
    if spaces_list[1] == spaces_list[2]  == spaces_list[3] != 0:
        return spaces_list[1]
    elif spaces_list[4] == spaces_list[5] == spaces_list[6] != 0:
        return spaces_list[4]
    elif spaces_list[7] == spaces_list[8] == spaces_list[9] != 0:
        return spaces_list[7]
    #columns
    elif spaces_list[1] == spaces_list[4] == spaces_list[7] != 0:
        return spaces_list[1]
    elif spaces_list[2] == spaces_list[5] == spaces_list[8] != 0:
        return spaces_list[2]
    elif spaces_list[3] == spaces_list[6] == spaces_list[9] != 0:
        return spaces_list[3]
    #diagonals
    elif spaces_list[1] == spaces_list[5] == spaces_list [9] != 0:
        return spaces_list[1]
    elif spaces_list[3] == spaces_list[5] == spaces_list[7] != 0:
        return spaces_list[3]
    else:
        return None
...
def printboard(playspace):    
    ...
    for x in playspace.values():
        if x == 1:
            ...
            board.append("_")
        print(x, board, playspace.values(), playspace)
